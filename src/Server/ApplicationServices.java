...
public class ApplicationServices {
    ...
    public static void returnResetStudentsVerificationResult() throws IOException {
        ServerThread.printWriter.println("SERVER_READY");
        boolean resetSuccess = QueryFunctions.resetStudentsVerification();
        System.out.println("Result: " + resetSuccess);
        ServerThread.dataOut.writeBoolean(resetSuccess);
    }
    ...
    static void returnStatistics() throws IOException {
        ...
        System.out.println("Result: "+statistics.toString());
